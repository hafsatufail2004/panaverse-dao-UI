...
<div className="mt-20 mb-14">
    <hr/>
    <div className="flex mr-20 md:mr-40">
    {/* right contenr */}
<div>
    <Image src={logo} alt="Panaverse" className="w-[170px] h-[120px] px-3 pt-6"/>

<p className="text-gray-600 md:text-lg text-[12px] w-[250px] md:w-[500px] md:px-3 pt-6">Certified Web 3.0 and Metaverse Developer A One and Quarter Years Panaverse DAO Earn as you Learn Program Getting Ready for the Next Generation of the Internet</p>

<div className="flex md:mx-8 gap-x-4 sm:mt-5">
...
<div className="w-11 h-11 rounded-full bg-blue-500 text-white flex items-center justify-center">
    ...
    <div className="w-11 h-11  rounded-full text-white bg-blue-500 flex items-center justify-center">
...
<div className="md:px-16 px-6">
    <h3 className="font-semibold md:text-xl text-md text-[#1A202c] pt-10 pb-3 ">Programs</h3>
    <ul className="md:text-[16px] text-[10px]  text-gray-600">
        <li className="md:py-2">Web 3.0 and Metaverse Developer</li>
        <li className="md:py-2">Artificial Intelligence</li>
        <li className="py-2">Cloud-Native Computing</li>
        <li className="py-2">Ambient Computing and IoT</li>
        <li className="py-2">Genomics and Bioimformatics</li>
        <li className="py-2">Network Programmability and Automation</li>
    </ul>
</div>

{/* left content */}
<div>
<h3 className="font-semibold text-xl text-[#1A202c] pt-10 pb-3">Pages</h3>
    <ul className="text-[10px] md:text-[16px] text-gray-600">
        <li className="py-2">Home</li>
        <li className="py-2">Quarter 1</li>
        <li className="py-2">Quarter 2</li>
        <li className="py-2">Quarter 3</li>
    </ul>
</div>
